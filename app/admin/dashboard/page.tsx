      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <button className="bg-green-500 text-white py-4 rounded-lg hover:bg-green-600 font-semibold">
              Manage Menu
            </button>
            <button className="bg-orange-500 text-white py-4 rounded-lg hover:bg-orange-600 font-semibold">
              View Orders
            </button>
            <button className="bg-purple-500 text-white py-4 rounded-lg hover:bg-purple-600 font-semibold">
              Generate QR Codes
            </button>
          </div>
        </div>
